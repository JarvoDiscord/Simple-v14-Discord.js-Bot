...
module.exports = async (client, interaction) => {
    if (!interaction.isCommand() && !interaction.isContextMenuCommand() && !interaction.isButton()) return; // When the interaction is not a command, not a contextmenu, or not a button, it will not execute.
